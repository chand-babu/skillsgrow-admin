...
const PORT = process.env.BB_PORT || 3000;
...
const template = fs.readFileSync(path.join('dist/skillsgrow-admin', 'index.html')).toString();
...
app.set('views', 'dist/skillsgrow-admin');
app.set('view cache', true);
app.use('/', express.static('dist/skillsgrow-admin', { index: false, maxAge: 30 * 86400000 }));
